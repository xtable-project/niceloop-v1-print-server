...
// const deplay = (millisec) => {
//   return new Promise((resolve) => setTimeout(resolve, millisec));
// };

// const run = async () => {
//   let settings = await fetchSetting();
//   let refreshTime = settings.refreshTime ? settings.refreshTime * 1000 : 10000;

//   while (refreshTime) {
//     await watchPrinter(settings.alertTime);
//     await deplay(refreshTime);
//   }
// };
